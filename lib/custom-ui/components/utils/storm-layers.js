...
export const LAYER_TYPES = ["cone", "line", "points"];
...
export function getTruncatedId(uniqueId) {
...
export function createComposite(icon_url, new_id, terria, item) {
  ...
  legend_trait.url = icon_url + "hurr-layers-legend.png";
